...
(function (window, document, $, Granite) {
    ...
    var ACL_CHECK_COMMAND = '/content/aembox-linkchecker/servlet/aclCheck';
    ...
    var RESOURCE_EXIST_CHECK_COMMAND = '/content/aembox-linkchecker/servlet/resourceExistCheck';
